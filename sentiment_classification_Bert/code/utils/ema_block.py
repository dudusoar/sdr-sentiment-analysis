...
class EMA(object):
    ...
    Use EMA to accumulate model parameters

    Args:
        parameters (:obj:`list`): Model parameters to be trained
        decay (:obj:`float`): Exponential decay rate
    ...
    Examples::
        ...
        >>>     # During training, after updating parameters, synchronize shadow weights
        >>>     optimizer.step()
        >>>     ema.update(module.parameters())
        >>> # Before evaluation, replace weights with EMA; after evaluation, restore original model parameters
